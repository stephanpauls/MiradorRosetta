(function($) {
    ...
    $.MainMenu.prototype = {
        ...
        '{{#if showBookmark}}',
          '<li>',
            '<a href="javascript:;" class="bookmark-workspace mainmenu-button" title="{{t "Toggle bookmark"}}" aria-label="{{t "Toggle bookmark"}}">',
        ...
        '{{#if showLayout}}',
          '<li>',
            '<a href="javascript:;" class="change-layout mainmenu-button" title="{{t "Change the number of visible slots"}}" aria-label="{{t "Change the number of visible slots"}}">',
        ...
        '{{#if showFullScreenViewer}}',
          '<li>',
            '<a href="javascript:;" class="fullscreen-viewer mainmenu-button" title="{{t "Toggle full screen"}}" aria-label="{{t "Toggle full screen"}}">',
