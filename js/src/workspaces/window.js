(function($) {
  ...
  $.Window.prototype = {
    ...
    template: Handlebars.compile([
                                 ...
                                 '</a>',
                                 '{{#if MetadataView}}',
                                 '<a href="javascript:;" class="mirador-btn mirador-icon-metadata-view mirador-tooltip" role="button" title="{{t "View information/metadata about this object"}}" aria-label="{{t "View information/metadata about this object"}}">',
                                 '<i class="fa fa-info-circle fa-lg fa-fw"></i>',
                                 '</a>',
                                 '{{/if}}',
                                 '{{#if showFullScreen}}',
                                 '<a class="mirador-btn mirador-osd-fullscreen mirador-tooltip" role="button" title="{{t "Toggle this windo to full screen"}}" aria-label="{{t "Toggle this windo to full screen"}}">',
                                 ...
                                 '{{/if}}',
                                 '{{#if displayLayout}}',
                                 '<a href="javascript:;" class="mirador-btn mirador-icon-window-menu" title="{{t "Change the number of visible slots"}}" aria-label="{{t "Change the number of visible slots"}}"><i class="fa fa-th-large fa-lg fa-fw"></i><i class="fa fa-caret-down"></i>',
                                 ...
                                 '{{/if}}',
                                 '{{#if sidePanel}}',
                                 '<a href="javascript:;" class="mirador-btn mirador-icon-toc selected mirador-tooltip" title="{{t "Toggle the side panel"}}" aria-label="{{t "Toggle the side panel"}}"><i class="fa fa-bars fa-lg fa-fw"></i></a>',
                                 '{{/if}}',
