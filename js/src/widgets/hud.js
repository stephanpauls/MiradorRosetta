  ...
  $.Hud.prototype = {
    ...
    template: Handlebars.compile([
                                 ...
                                 '{{#if showAnno}}',
                                  ...
                                  '<a class="mirador-osd-annotations-layer hud-control" role="button" title="{{t "Toggle annotations"}}" aria-label="{{t "Toggle annotations"}}">',
                                 ...
                                 '{{#if showImageControls}}',
                                  ...
                                  '<a class="mirador-manipulation-toggle hud-control" role="button" title="{{t "Toggle image manipulation"}}" aria-label="{{t "Toggle image manipulation"}}">',
